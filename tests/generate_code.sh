...
../flatc --binary --cpp --kotlin  --csharp --dart --go --lobster --lua --js --ts --php --swift --grpc \
...
../flatc --cpp --kotlin --csharp --dart --go --binary --lobster --lua --js --ts --php --python --rust \
...
../flatc --cpp --kotlin --csharp --js --ts --php --swift $TEST_BASE_FLAGS $TEST_CPP_FLAGS $TEST_CS_FLAGS -o union_vector ./union_vector/union_vector.fbs
...
../flatc --cpp --kotlin --csharp --python $TEST_NOINCL_FLAGS $TEST_CPP_FLAGS $TEST_CS_FLAGS monster_extra.fbs monsterdata_extra.json
../flatc --cpp --csharp --jsonschema $TEST_NOINCL_FLAGS $TEST_CPP_FLAGS $TEST_CS_FLAGS --scoped-enums arrays_test.fbs
