package benchmark.flexdb.android.booking.com.benchmark.flexdb.flatbuffers
...
internal object JavaTest {
    ...
    fun main(args: Array<String>) {
        ...
        val file = File("monsterdata_test.mon")
        ...
        try {
            ...
            println("FlatBuffers test: couldn't read file")
            return
        }
    ...
    fun TestBuffer(bb: ByteBuffer) {
        ...
        TestEq(monster.testType(), Any.Monster as Byte)
    ...
    fun TestNamespaceNesting() {
        ...
        val off = TableInFirstNS.endTableInFirstNS(fbb)
    }
    ...
    fun TestBuilderBasics(fbb: FlatBufferBuilder, sizePrefix: Boolean) {
        ...
        Monster.addTestType(fbb, Any.Monster as Byte)
        ...
        TestEq(monster.testType(), Any.NONE as Byte)
    ...
    fun TestVectorOfUnions() {
        ...
        val characterTypeVector = byteArrayOf(Character.MuLan)
    ...
    fun <T> TestEq(a: T, b: T) {
        if (a != b) {
            println("" + a.javaClass.getName() + " " + b.javaClass.getName())
